...
//        UIApplication.shared.windows.first?.rootViewController = mainboard
//        UIApplication.shared.windows.first?.makeKeyAndVisible()
        guard let islogged = hashtoken else { return }
        print(islogged)
        if islogged == true {
            let mainboard = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "mainboard")
                    UIApplication.shared.windows.first?.rootViewController = mainboard
            ...
            let loginscreen = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "loginscreen")
                   UIApplication.shared.windows.first?.rootViewController = loginscreen
                    UIApplication.shared.windows.first?.makeKeyAndVisible()
        }
    }
